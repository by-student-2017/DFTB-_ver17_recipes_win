...
find /v "KPT" <dos_zn.1.out> dos.dat
gnuplot pdos_spin.gp
move dos_spin.png .\plot\dos_zn.s.png
move dos_spin.plot .\plot\dos_zn.s.plot

find /v "KPT" <dos_zn.2.out> dos.dat
gnuplot pdos_spin.gp
move dos_spin.png .\plot\dos_zn.p.png
move dos_spin.plot .\plot\dos_zn.p.plot

find /v "KPT" <dos_zn.3.out> dos.dat
gnuplot pdos_spin.gp
move dos_spin.png .\plot\dos_zn.d.png
move dos_spin.plot .\plot\dos_zn.d.plot
