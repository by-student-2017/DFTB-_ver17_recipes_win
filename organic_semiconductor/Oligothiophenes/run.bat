...
find /v "KPT" <dos_s.1.out> dos.dat
gnuplot pdos.gp
move dos.png .\plot\dos_s.s.png
move dos.plot .\plot\dos_s.s.plot

find /v "KPT" <dos_s.2.out> dos.dat
gnuplot pdos.gp
move dos.png .\plot\dos_s.p.png
move dos.plot .\plot\dos_s.p.plot

find /v "KPT" <dos_s.3.out> dos.dat
gnuplot pdos.gp
move dos.png .\plot\dos_s.d.png
move dos.plot .\plot\dos_s.d.plot
...
find /v "KPT" <dos_h.1.out> dos.dat
gnuplot pdos.gp
