...
gnuplot pdos.gp
move dos.png .\plot\dos_cu.s.png
move dos.plot .\plot\dos_cu.s.plot

find /v "KPT" <dos_cu.2.out> dos.dat
gnuplot pdos.gp
move dos.png .\plot\dos_cu.p.png
move dos.plot .\plot\dos_cu.p.plot

find /v "KPT" <dos_cu.3.out> dos.dat
gnuplot pdos.gp
move dos.png .\plot\dos_cu.d.png
move dos.plot .\plot\dos_cu.d.plot
