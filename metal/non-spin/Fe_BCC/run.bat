...
gnuplot pdos.gp
move dos.png .\plot\dos_fe.s.png
move dos.plot .\plot\dos_fe.s.plot

find /v "KPT" <dos_fe.2.out> dos.dat
gnuplot pdos.gp
move dos.png .\plot\dos_fe.p.png
move dos.plot .\plot\dos_fe.p.plot

find /v "KPT" <dos_fe.3.out> dos.dat
gnuplot pdos.gp
move dos.png .\plot\dos_fe.d.png
move dos.plot .\plot\dos_fe.d.plot
