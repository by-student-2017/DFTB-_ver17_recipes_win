...
gnuplot pdos.gp
move dos.png .\plot\dos_ni.s.png
move dos.plot .\plot\dos_ni.s.plot

find /v "KPT" <dos_ni.2.out> dos.dat
gnuplot pdos.gp
move dos.png .\plot\dos_ni.p.png
move dos.plot .\plot\dos_ni.p.plot

find /v "KPT" <dos_ni.3.out> dos.dat
gnuplot pdos.gp
move dos.png .\plot\dos_ni.d.png
move dos.plot .\plot\dos_ni.d.plot
