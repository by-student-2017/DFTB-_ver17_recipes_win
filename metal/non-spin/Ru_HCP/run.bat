...
find /v "KPT" <dos_ru.1.out> dos.dat
gnuplot pdos.gp
move dos.png .\plot\dos_ru.s.png
move dos.plot .\plot\dos_ru.s.plot

find /v "KPT" <dos_ru.2.out> dos.dat
gnuplot pdos.gp
move dos.png .\plot\dos_ru.p.png
move dos.plot .\plot\dos_ru.p.plot

find /v "KPT" <dos_ru.3.out> dos.dat
gnuplot pdos.gp
move dos.png .\plot\dos_ru.d.png
move dos.plot .\plot\dos_ru.d.plot
