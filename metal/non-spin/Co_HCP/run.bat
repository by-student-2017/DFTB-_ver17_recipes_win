...
gnuplot pdos.gp
move dos.png .\plot\dos_co.s.png
move dos.plot .\plot\dos_co.s.plot

find /v "KPT" <dos_co.2.out> dos.dat
gnuplot pdos.gp
move dos.png .\plot\dos_co.p.png
move dos.plot .\plot\dos_co.p.plot

find /v "KPT" <dos_co.3.out> dos.dat
gnuplot pdos.gp
move dos.png .\plot\dos_co.d.png
move dos.plot .\plot\dos_co.d.plot
