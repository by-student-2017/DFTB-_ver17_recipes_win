...
find /v "KPT" <dos_fe.1.out> dos.dat
gnuplot pdos_spin.gp
move dos_spin.png .\plot\dos_fe.s.png
move dos_spin.plot .\plot\dos_fe.s.plot

find /v "KPT" <dos_fe.2.out> dos.dat
gnuplot pdos_spin.gp
move dos_spin.png .\plot\dos_fe.p.png
move dos_spin.plot .\plot\dos_fe.p.plot

find /v "KPT" <dos_fe.3.out> dos.dat
gnuplot pdos_spin.gp
move dos_spin.png .\plot\dos_fe.d.png
move dos_spin.plot .\plot\dos_fe.d.plot
