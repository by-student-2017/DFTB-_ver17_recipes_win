...
find /v "KPT" <dos_co.1.out> dos.dat
gnuplot pdos_spin.gp
move dos_spin.png .\plot\dos_co.s.png
move dos_spin.plot .\plot\dos_co.s.plot

find /v "KPT" <dos_co.2.out> dos.dat
gnuplot pdos_spin.gp
move dos_spin.png .\plot\dos_co.p.png
move dos_spin.plot .\plot\dos_co.p.plot

find /v "KPT" <dos_co.3.out> dos.dat
gnuplot pdos_spin.gp
move dos_spin.png .\plot\dos_co.d.png
move dos_spin.plot .\plot\dos_co.d.plot
