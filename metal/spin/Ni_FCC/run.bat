...
find /v "KPT" <dos_ni.1.out> dos.dat
gnuplot pdos_spin.gp
move dos_spin.png .\plot\dos_ni.s.png
move dos_spin.plot .\plot\dos_ni.s.plot

find /v "KPT" <dos_ni.2.out> dos.dat
gnuplot pdos_spin.gp
move dos_spin.png .\plot\dos_ni.p.png
move dos_spin.plot .\plot\dos_ni.p.plot

find /v "KPT" <dos_ni.3.out> dos.dat
gnuplot pdos_spin.gp
move dos_spin.png .\plot\dos_ni.d.png
move dos_spin.plot .\plot\dos_ni.d.plot
