...
find /v "KPT" <dos_mg.1.out> dos.dat
gnuplot pdos.gp
move dos.png .\plot\dos_mg.s.png
move dos.plot .\plot\dos_mg.s.plot

find /v "KPT" <dos_mg.2.out> dos.dat
gnuplot pdos.gp
move dos.png .\plot\dos_mg.p.png
move dos.plot .\plot\dos_mg.p.plot
